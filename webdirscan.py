...
class Dirscan(object):
    ...
    def _analysis404(self):
        notFoundPage = requests.get(self.scanSite + '/tsaizq/hello.html', allow_redirects=False)
        self.notFoundPageText = notFoundPage.text.replace('/tsaizq/hello.html', '')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--thread', dest="threadNum", help="Number of threads running the program", type=int, default=20)
